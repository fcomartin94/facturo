...
/**
 * Lee el backend activo en cada petición (no en el import),
 * para que el cambio de selector en la pantalla de login surta efecto inmediato.
 */
function getApiBase() {
    return localStorage.getItem('api_backend') ?? BACKENDS.java;
}
