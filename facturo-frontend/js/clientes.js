...
/**
 * Fetches all clients for the authenticated user and renders them in the table.
 * Called on page load and after every create/update/delete operation.
 */
...
/**
 * Opens the modal pre-filled with the client's current data for editing.
 * Exposed on window so it can be called from inline onclick handlers in the table.
 *
 * @param {number} id - Client ID to load.
 */
...
/**
 * Asks for confirmation, deletes the client, and refreshes the table.
 * Exposed on window so it can be called from inline onclick handlers in the table.
 *
